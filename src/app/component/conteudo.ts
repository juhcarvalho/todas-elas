    ...
    conteudosCard = [
        {
            ...
            texto: `A Plataforma Mulher Segura conecta mulheres em situação de violência aos canais de apoio disponíveis por todo o País. 
            Apresentamos caminhos para ruptura do ciclo da violência doméstica, 
            facilitando o acesso a serviços especializados, processos formativos e acolhedores.`,
            url: 'https://www.mulhersegura.org/direitos-das-mulheres/voce-nao-esta-sozinha/o-que-e-violencia-baseada-em-genero'
        },
        {
            titulo: 'Onde encontrar ajuda?',
            texto: `Para encontrar o apoio que você precisa em sua região (Estado e Cidade), acesse a plataforma 
